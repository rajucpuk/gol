  ...
  stages {
    ...
    stage('deploy') {
      ...
      steps {
        ...
        bat 'xcopy /y C:\\users\\pohu\\.jenkins\\workspace\\GOL_Pipeline\\gameoflife-web\\target\\gameoflife.war "C:\\Program Files\\Apache Software Foundation\\Tomcat 7.0\\webapps"'
